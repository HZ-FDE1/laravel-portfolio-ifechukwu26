...
<nav class="navigation">
    <div class="nav-items">
        <a href="index.html" class="dash_tab">Home</a>
        <a href="profile.html" class="dash_tab">Profile</a>
        <a href="dashboard.html" class="dash_tab">Dashboard</a>
        <a href="blog.html" class="dash_tab">Blog</a>
        <a href="faq.html" class="dash_tab">FAQ</a>
    </div>
